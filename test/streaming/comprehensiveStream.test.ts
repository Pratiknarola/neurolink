 ...
 *
 * IMPORTANT: Provider-Specific Input Handling
 * Some AI providers (notably Google AI) exhibit inconsistent behavior with certain input patterns:
 * - Inputs containing domain keywords like "analytics", "healthcare", "streaming" may return empty responses
 * - This affects both basic streaming AND factory-enhanced streaming equally
 * - This is a provider-specific issue, not related to factory integration or streaming implementation
 * - Factory pattern integration works correctly when providers return expected responses
 *
 * For reliable testing, use provider-friendly inputs like:
 * ✅ "Hello world", "Count from 1 to 5", "Say hello", "Tell me a joke"
 * ⚠️ Avoid: "Test analytics", "healthcare data", "streaming analysis", etc.
 */
...
describe("Comprehensive Streaming Tests", () => {
  ...
  describe("Domain Configuration Integration with Streaming", () => {
    beforeEach(() => {
      // Reset enhancement statistics for each test
